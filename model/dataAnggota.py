...
class DataAnggotaPage(QWidget):  # Pastikan ini subclass QWidget
    def __init__(self):
        ...
        self.ui.deselectBtn.clicked.connect(self.ui.AnggotaTable.clearSelection)
    ...
    def populate_table(self):
        ...
        try:
            ...
            self.ui.AnggotaTable.setRowCount(len(rows))  # Set number of rows
            self.ui.AnggotaTable.setColumnCount(5)  # 5 columns for each field (nama, email, telp, jenis_kelamin, alamat)
    ...
    def search_data(self):
        ...
        # Flag untuk mengetahui apakah ada kolom yang harus dicari
        row_found = False  # Flag untuk menandakan apakah ada baris yang ditemukan
        ...
        for row in range(self.ui.AnggotaTable.rowCount()):
            ...
            match_found = True  # Asumsikan kecocokan ditemukan
