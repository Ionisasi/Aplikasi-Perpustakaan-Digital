...
################################################################################
## Form generated from reading UI file 'RegistrasiAnggota.ui'
##
...
"QCheckBox::indicator:unchecked{background-color : rgb(46, 47, 48);}")
        ...
        self.jeniskelaminButtonGroup.setObjectName(u"jeniskelaminButtonGroup")
        self.jeniskelaminButtonGroup.addButton(self.PerempuanCheckBox)
        ...
        self.jeniskelaminButtonGroup.addButton(self.lakiCheckBox)
