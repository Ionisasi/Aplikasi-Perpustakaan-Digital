...
"")
        ...
        self.horizontalLayout_5 = QHBoxLayout(self.editBtn)
        self.horizontalLayout_5.setSpacing(0)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.horizontalLayout_5.setContentsMargins(10, 0, 14, 10)
...
""")
        ...
        if (self.AnggotaTable.rowCount() < 10):
            self.AnggotaTable.setRowCount(10)
